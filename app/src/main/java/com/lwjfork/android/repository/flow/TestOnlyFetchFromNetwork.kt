...
abstract class TestOnlyFetchFromNetwork<ResultType>(resourceFactory: ResourceFactory = DefaultResourceFactory.getInstance()
) : OnlyFetchFromNetwork<ResultType, Response<ResultType>>(resourceFactory) {
